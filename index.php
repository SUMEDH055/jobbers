...
<!-- Main Container -->
<div class="container-fluid" style=" background-color: #002436; background-position: center; background-size: cover; background-repeat: no-repeat; background-attachment: fixed;">
                    ...
                    <div style=" margin-top: 30px; padding-left: 50px;">
                        ...
                        <button type="submit" style="height:45px; width:160px; border-radius:0px 30px 30px 0px; background-color: #257059; "><i class="fa fa-search bb"></i></button>
                            ...
                            <!----------------------SUM OF POSTS & ACTIVE USERS USING VIEW TABLES--------------------------->
                                        ...
                                        <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;"> Total Job Posts Applied: ...</h3>
                                        ...
                                        <h3 style="font-family: 'Schoolbell', cursive; font-family: 'Vollkorn', serif; color: #f2cc8f; padding-left:4px;"> Active people : ..</h3>
                            ...
                            <div class="row">
                            <div class="jumbotron" style="width: 40rem; background: #384080;">
  <h1 class="display-4" style="color: #F8D4A7; margin-right: 20rem;">Upgrade, to pro!</h1>
  <hr class="my-4">
                               ...
                               while(  $row=$result->fetch_assoc())
                                {
                                 ...
                                 $status=$row['status'];
                             ?>   
                                <div class="col-md-4 crd" style="margin: 20px; background-color:#50479A; padding: 20px;">
